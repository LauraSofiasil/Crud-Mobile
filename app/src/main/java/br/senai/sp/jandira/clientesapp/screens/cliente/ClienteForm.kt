        ...
        Column(
            ...
            OutlinedTextField(
                ...
                keyboardOptions = KeyboardOptions(
                    keyboardType = KeyboardType.Text, //Estilo de teclado de texto
                    capitalization = KeyboardCapitalization.Words,  //Primeira letra maiúscula
                    imeAction = ImeAction.Next    //Passar para o próximo campo
                ),
                isError = isNomeError,
                supportingText = {
                    if (isNomeError){
            ...
            OutlinedTextField(
                ...
                keyboardOptions = KeyboardOptions(
                    keyboardType = KeyboardType.Email, //Estilo de teclado de texto
                    imeAction = ImeAction.Done  //Fechar o teclado
                ),
